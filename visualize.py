...
# Use the functions
visualize_model_architecture('neurogenesis_model_custom.h5')
print(predict_image('neurogenesis_model_custom.h5', 'C:/IMPORTANT STUFF/VIT/Sem 7/Project Sem 7/Project sample code/Experimentation/Alzheimer_s Dataset/train/NonDemented/nonDem0.jpg'))
